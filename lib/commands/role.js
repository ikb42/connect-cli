...
function registerRole (cli, options, done) {
  ...
  roleCmd
    .handler(function (data, flags, done) {
      ...
      cli.log('  nvl role:scopes [<role name>] [--issuer | -i <issuer id>]')

      cli.log('  nvl role:permit [<role name> <scope name>] [--issuer | -i <issuer id>]')

      cli.log('  nvl role:forbid [<role name> <scope name>] [--issuer | -i <issuer id>]')
