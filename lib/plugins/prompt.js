...
// Create a prompt module to access prompts and registerPrompt
var promptModule = inquirer.createPromptModule()
...
function registerPrompt (cli, options, done) {
  ...
  */
  ...
  try {
    promptModule.registerPrompt('multiinput', promptModule.prompts.input)
  } catch (e) {
    // If registration fails, multiinput may not be available
    // This is acceptable as it's a custom extension
  }
